...
function emailRegex(input: Field[]) {
        ...
        for (let i = 0; i < num_bytes; i++) {
                const lt0 = Field(47).lessThan(input[i]);
                const lt1 = input[i].lessThan(58);
                const and0 = lt0.and(lt1);
                const lt2 = Field(64).lessThan(input[i]);
                const lt3 = input[i].lessThan(91);
                const and1 = lt2.and(lt3);
                const lt4 = Field(96).lessThan(input[i]);
                const lt5 = input[i].lessThan(123);
                ...
                const lt6 = Field(47).lessThan(input[i]);
                const lt7 = input[i].lessThan(58);
                const and4 = lt6.and(lt7);
                const lt8 = Field(64).lessThan(input[i]);
                const lt9 = input[i].lessThan(91);
                const and5 = lt8.and(lt9);
                const lt10 = Field(96).lessThan(input[i]);
                const lt11 = input[i].lessThan(123);
                ...
                states[i+1][2] = and8;
                state_changed[i] = state_changed[i].or(states[i+1][2]);
                const lt12 = Field(47).lessThan(input[i]);
                const lt13 = input[i].lessThan(58);
                const and9 = lt12.and(lt13);
                const lt14 = Field(64).lessThan(input[i]);
                const lt15 = input[i].lessThan(91);
                const and10 = lt14.and(lt15);
                const lt16 = Field(96).lessThan(input[i]);
                const lt17 = input[i].lessThan(123);
                ...
                const lt18 = Field(47).lessThan(input[i]);
                const lt19 = input[i].lessThan(58);
                const and13 = lt18.and(lt19);
                const lt20 = Field(64).lessThan(input[i]);
                const lt21 = input[i].lessThan(91);
                const and14 = lt20.and(lt21);
                const lt22 = Field(96).lessThan(input[i]);
                const lt23 = input[i].lessThan(123);
                ...
                const lt24 = Field(47).lessThan(input[i]);
                const lt25 = input[i].lessThan(58);
                const and17 = lt24.and(lt25);
                const lt26 = Field(64).lessThan(input[i]);
                const lt27 = input[i].lessThan(91);
                ...
                const lt28 = Field(47).lessThan(input[i]);
                const lt29 = input[i].lessThan(58);
                const and20 = lt28.and(lt29);
                const lt30 = Field(64).lessThan(input[i]);
                const lt31 = input[i].lessThan(91);
                const and21 = lt30.and(lt31);
                const lt32 = Field(96).lessThan(input[i]);
                const lt33 = input[i].lessThan(123);
...
function base64Regex(input: Field[]) {
        ...
        for (let i = 0; i < num_bytes; i++) {
                ...
                const lt11 = input[i].lessThan(123);
                const and6 = lt10.and(lt11);
                const eq3 = input[i].equals(43);
                const eq4 = input[i].equals(47);
                const eq5 = input[i].equals(61);
                let multi_or1 = Bool(false);
                multi_or1 = multi_or1.or(and4);
                multi_or1 = multi_or1.or(and5);
                multi_or1 = multi_or1.or(and6);
